...
contract RewardControl is IRewardControl, ExponentialNoError {
    ...
    // @notice The underlying EtaVault contract
    EtaVault public deltaOpen;
    ...
    function setEtaVault(address tauVault_) public onlyOwner {
        require(tauVault_ != address(0), "Address is empty");
        deltaOpen = EtaVault(tauVault_);
    }
