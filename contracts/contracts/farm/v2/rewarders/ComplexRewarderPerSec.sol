...
import "../interfaces/IEtaDistributorV2.sol";
import "../libraries/BoringERC20.sol";

/**
 * This is a sample contract to be used in the EtaDistributorV2 contract for partners to reward
...
contract ComplexRewarderPerSec is IComplexRewarder, Ownable, ReentrancyGuard {
    ...
    IEtaDistributorV2 public immutable distributorV2;
    ...
    modifier onlyDistributorV2() {
        require(
            ...
            "onlyDistributorV2: only EtaDistributorV2 can call this function"
        );
        _;
    }
    ...
    constructor(
        ...
        IEtaDistributorV2 _distributorV2,
        bool _isNative
    ) {
        require(
        ...
        require(
            ...
            "constructor: EtaDistributorV2 must be a valid contract"
        );
    ...
    /// @notice Function called by EtaDistributorV2 whenever staker claims SOLAR harvest. Allows staker to also receive a 2nd reward token.
