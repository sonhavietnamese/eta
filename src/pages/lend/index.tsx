...
export default function Vault(): JSX.Element {
    ...
    useEffect(() => {
        getLendMarkets(account, network).then((res) => setMarkets(res))
    }, [account])
                                        ...
                                        <div className={`hidden md:block`}>
                                            <div className={`col-span-12 md:col-span-4 bg-dark-800 px-6 py-4 rounded`}>
                                                ...
                                                <div className="mb-4 text-base text-secondary">
                                                    <p>
                                                        {`The Eta Lending Vault is a set of high incentivized lending pools. Users can choose to lend their assets
                                                          for high rewards.`}
                                                    </p>
                                                    <p className="mt-2">
                                                        {`In exchange for their lent assets, lenders receive interest-bearing tokens which they may use to mint etaUSD,
                                                          an innovative, auto-farming stablecoin on Eta.`}
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
