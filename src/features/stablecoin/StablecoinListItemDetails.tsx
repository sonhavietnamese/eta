...
import { chainIdToString, DEPLOYMENTS } from "../../constants/addresses"
...
const BorrowVaultListItemDetails = ({ farm }) => {
    ...
    const [approvalState, approve] = useApproveCallback(typedDepositValue, DEPLOYMENTS[chainIdToString(network)].stablecoin.etaUSD)
                        ...
                        {approvalState === ApprovalState.NOT_APPROVED || approvalState === ApprovalState.PENDING ? (
                            ...
                            <Button
                                ...
                                onClick={async () => {
                                    setPendingTx(true)
                                    try {
                                        const tx = await mint(account, farm?.ibToken, depositValue.toBigNumber(18), network)
