...
import { useEtaDistributorContract, useBNBPairContract, useSolarMovrContract, useEtaVaultContract } from "../../hooks"
...
export function useUserInfo(farm, token) {
    ...
    const contract = useEtaVaultContract()
...
export function usePositions() {
    return useSolarPositions(useEtaVaultContract())
}
...
export function useVaults() {
    return useSolarVaults(useEtaVaultContract())
}
...
export function useSolarVaultInfo() {
    return useVaultInfo(useEtaVaultContract())
}
