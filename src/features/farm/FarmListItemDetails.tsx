...
import { ETA_DISTRIBUTOR_ADDRESS, MINICHEF_ADDRESS } from "../../constants/addresses"
...
const FarmListItem = ({ farm }) => {
    ...
    const [approvalState, approve] = useApproveCallback(typedDepositValue, ETA_DISTRIBUTOR_ADDRESS[chainId])
