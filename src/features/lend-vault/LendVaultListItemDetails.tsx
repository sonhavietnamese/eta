...
import { ETA_VAULT_ADDRESS } from "../../constants/addresses"
...
const LendVaultListItem = ({ farm }) => {
    ...
    const [approvalState, approve] = useApproveCallback(typedDepositValue, ETA_VAULT_ADDRESS[chainId])
                        ...
                        <div className="col-span-2 text-center md:col-span-1">
                            ...
                            {approvalState === ApprovalState.NOT_APPROVED || approvalState === ApprovalState.PENDING ? (
                                ...
                                <Button
                                    ...
                                    onClick={async () => {
                                        setPendingTx(true)
                                        const tx = await lend(account, farm?.asset, depositValue.toBigNumber(18), network)
                            ...
                            <Button
                                ...
                                onClick={async () => {
                                    ...
                                    try {
                                        ...
                                        const tx = await withdraw(account, farm?.asset, withdrawValue.toBigNumber(18), network)
                                        addTransaction(
                                            { hash: tx.transactionHash, ...tx },
                                            {
                                                summary: `${`Withdraw`} ${
