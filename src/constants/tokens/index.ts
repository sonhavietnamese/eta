...
export const MANTLE_TESTNET: { [key: string]: Token } = {
    wETH: new Token(ChainId.MANTLE_TESTNET, getDeployedAddresses().mantle.tokens.wETH, 18, "wETH", "Wrapped BIT"),
    GAMMA: new Token(ChainId.MANTLE_TESTNET, getDeployedAddresses().mantle.tokens.ETA, 18, "ETA", "Eta Token"),
    DCT: new Token(ChainId.MANTLE_TESTNET, getDeployedAddresses().mantle.tokens.DCT, 18, "DCT", "Doggy Coin Token"),
    MAV: new Token(ChainId.MANTLE_TESTNET, getDeployedAddresses().mantle.tokens.MAV, 18, "MAV", "Maverick Token"),
    WLR: new Token(ChainId.MANTLE_TESTNET, getDeployedAddresses().mantle.tokens.WLR, 18, "WLR", "Wallaroo Token"),
    DIB: new Token(ChainId.MANTLE_TESTNET, getDeployedAddresses().mantle.tokens.DIB, 18, "DIB", "Dib Token"),
}

export const CHIADO_TESTNET: { [key: string]: Token } = {
    wETH: new Token(ChainId.CHIADO, getDeployedAddresses().chiado.tokens.wETH, 18, "wxDAI", "Wrapped xDAI"),
    GAMMA: new Token(ChainId.CHIADO, getDeployedAddresses().chiado.tokens.ETA, 18, "ETA", "Eta Token"),
    DCT: new Token(ChainId.CHIADO, getDeployedAddresses().chiado.tokens.DCT, 18, "DCT", "Doggy Coin Token"),
    MAV: new Token(ChainId.CHIADO, getDeployedAddresses().chiado.tokens.MAV, 18, "MAV", "Maverick Token"),
    WLR: new Token(ChainId.CHIADO, getDeployedAddresses().chiado.tokens.WLR, 18, "WLR", "Wallaroo Token"),
    DIB: new Token(ChainId.CHIADO, getDeployedAddresses().chiado.tokens.DIB, 18, "DIB", "Dib Token"),
}

export const SCROLL_TESTNET: { [key: string]: Token } = {
    wETH: new Token(ChainId.SCROLL, getDeployedAddresses().scroll_alpha.tokens.wETH, 18, "wETH", "Wrapped ETH"),
    GAMMA: new Token(ChainId.SCROLL, getDeployedAddresses().scroll_alpha.tokens.ETA, 18, "ETA", "Eta Token"),
    DCT: new Token(ChainId.SCROLL, getDeployedAddresses().scroll_alpha.tokens.DCT, 18, "DCT", "Doggy Coin Token"),
    MAV: new Token(ChainId.SCROLL, getDeployedAddresses().scroll_alpha.tokens.MAV, 18, "MAV", "Maverick Token"),
    WLR: new Token(ChainId.SCROLL, getDeployedAddresses().scroll_alpha.tokens.WLR, 18, "WLR", "Wallaroo Token"),
    DIB: new Token(ChainId.SCROLL, getDeployedAddresses().scroll_alpha.tokens.DIB, 18, "DIB", "Dib Token"),
}

export const ZKEVM_TESTNET: { [key: string]: Token } = {
    wETH: new Token(ChainId.POLYGON_ZKEVM, getDeployedAddresses().zkEVM.tokens.wETH, 18, "wETH", "Wrapped ETH"),
    GAMMA: new Token(ChainId.POLYGON_ZKEVM, getDeployedAddresses().zkEVM.tokens.ETA, 18, "ETA", "Eta Token"),
    DCT: new Token(ChainId.POLYGON_ZKEVM, getDeployedAddresses().zkEVM.tokens.DCT, 18, "DCT", "Doggy Coin Token"),
    MAV: new Token(ChainId.POLYGON_ZKEVM, getDeployedAddresses().zkEVM.tokens.MAV, 18, "MAV", "Maverick Token"),
    WLR: new Token(ChainId.POLYGON_ZKEVM, getDeployedAddresses().zkEVM.tokens.WLR, 18, "WLR", "Wallaroo Token"),
    DIB: new Token(ChainId.POLYGON_ZKEVM, getDeployedAddresses().zkEVM.tokens.DIB, 18, "DIB", "Dib Token"),
}
...
export const SOLAR_ADDRESS = {
    ...
    [ChainId.MANTLE_TESTNET]: deployments.mantle.tokens.ETA,
    [ChainId.CHIADO]: deployments.chiado.tokens.ETA,
    [ChainId.SCROLL]: deployments.scroll_alpha.tokens.ETA,
    [ChainId.POLYGON_ZKEVM]: deployments.zkEVM.tokens.ETA,
}

export const SOLAR: ChainTokenMap = {
    [ChainId.MANTLE_TESTNET]: new Token(
        ChainId.MANTLE_TESTNET,
        SOLAR_ADDRESS[ChainId.MANTLE_TESTNET],
        18,
        "ETA",
        "Eta Token"
    ),
    [ChainId.CHIADO]: new Token(ChainId.CHIADO, SOLAR_ADDRESS[ChainId.CHIADO], 18, "ETA", "Eta Token"),
    [ChainId.SCROLL]: new Token(ChainId.SCROLL, SOLAR_ADDRESS[ChainId.SCROLL], 18, "ETA", "Eta Token"),
    [ChainId.POLYGON_ZKEVM]: new Token(
        ChainId.POLYGON_ZKEVM,
        SOLAR_ADDRESS[ChainId.POLYGON_ZKEVM],
        18,
        "ETA",
        "Eta Token"
    ),
...
export const WETH9_EXTENDED: { [chainId: number]: Token } = {
    ...
    [SupportedChainId.MANTLE_TESTNET]: new Token(
        ChainId.MANTLE_TESTNET,
    ...
    [SupportedChainId.CHIADO]: new Token(ChainId.CHIADO, deployments.chiado.tokens.wETH, 18, "wETH", "wETH"),
    [SupportedChainId.SCROLL]: new Token(ChainId.SCROLL, deployments.scroll_alpha.tokens.wETH, 18, "wETH", "wETH"),
    [SupportedChainId.POLYGON_ZKEVM]: new Token(
        ChainId.POLYGON_ZKEVM,
        deployments.zkEVM.tokens.wETH,
        18,
        "wETH",
        "wETH"
    ),
