...
export const RPC = {
    ...
    [ChainId.CHIADO]: "https://rpc.chiadochain.net",
    [ChainId.SCROLL]: "https://alpha-rpc.scroll.io/l2",
    [ChainId.POLYGON_ZKEVM]: " https://rpc.public.zkevm-test.net",
    [ChainId.MANTLE_TESTNET]: "https://rpc.testnet.mantle.xyz",
}

export const network = new NetworkConnector({
    defaultChainId: Number(ChainId.MANTLE_TESTNET),
    urls: RPC,
})
...
export const injected = new InjectedConnector({
    supportedChainIds: [ChainId.MANTLE_TESTNET, ChainId.CHIADO, ChainId.SCROLL, ChainId.POLYGON_ZKEVM].map((m) =>
        Number(m)
    ),
})
